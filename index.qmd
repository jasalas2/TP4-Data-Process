...
especies_reptiles <- "especies-reptiles.csv"
data <- read.csv(especies_reptiles)


data_separado <-
# El excel con los datos de las especies de los reptiles solamente estaba generando una columna con los datos de las species y iucnRedListCategory unidos, por lo que se procedió a separar los datos creando dos columnas diferentes, una para species y otra con iucnRedListCategory para poder realizar el ejercicio.
  
  
  data |>
  separate(
    species.iucnRedListCategory,
    into = c("species", "iucnRedListCategory"),
    sep = ";"
  )
...
# Tabla 
categoria_cantidad <- data_separado %>%
